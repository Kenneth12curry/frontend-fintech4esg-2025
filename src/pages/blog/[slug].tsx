  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <article className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-10 p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl text-white text-center">
          <span className="text-gray-700 font-medium text-lg sm:text-xl">Share the article :</span>
          <div className="flex gap-3">
            <a
              href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(title)}&url=${encodeURIComponent(slug)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 sm:gap-2 bg-blue-500 text-white px-3 py-1.5 sm:px-4 sm:py-2 text-sm sm:text-base rounded-xl hover:bg-blue-600 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 sm:gap-2 bg-blue-700 text-white px-3 py-1.5 sm:px-4 sm:py-2 text-sm sm:text-base rounded-xl hover:bg-blue-800 transition-colors"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
